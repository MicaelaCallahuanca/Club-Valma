// Original wordmark inspired by the real Club Valma logo (mosaic icon + two-tone
// text), rebuilt from scratch for this prototype rather than reusing the brand's
// actual logo file. Swap for the real asset before shipping.
